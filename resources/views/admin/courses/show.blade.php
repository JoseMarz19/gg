<x-app-layout>
    ...
    <div class=" er grid grid-cols-1 lg:grid-cols-3 gap-6">

        @if (session('info'))
            <div class="lg:col-span-3" x-data="{ open: true }" x-show="open">
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    <strong class="font-bold">OPS OCURRIO UN ERROR :(</strong>
                    <span class="block sm:inline">NO SE PUEDE PUBLICAR UN CURSO QUE NO ESTE COMPLETO...</span>
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="card mb-12">
                <div class="card-body">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        @empty
                            <li class="text-gray-700 text-base"><i
                                    class="fas fa-exclamation-circle text-red-500 mr-2"></i>Este curso no tiene asignado
                                ninguna meta</li>
                        @endforelse
            ...
            <section class="mb-12">
                ...
                @empty
                    <article class="card">
                        <div class="card-body"><i class="fas fa-exclamation-circle text-red-500 mr-2"></i>Este curso no
                            tiene ninguna sección asignada</div>
                    </article>
                @endforelse
            </section>
            {{-- Requisitos --}}
            ...
            <section class="mb-8">
                ...
                <ul>
                    ...
                    @empty
                        <i class="fas fa-exclamation-circle text-red-500 mr-2"></i>Este curso no tiene ningun
                        requerimiento
                    @endforelse
                </ul>
            </section>
            ...
            <section>
                <h1 class="font-bold text-3xl">Decripcion</h1>
            ...
            <section class="card mb-6">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.courses.approved', $course) }}" class="mt-4" method="POST">
                        ...
                        <button class="btn btn-primary_verde w-full">Aprobar curso </button>
                    </form>

                    <a href="{{ route('admin.courses.observation', $course) }}" class="btn btn-danger_rojo btn-blue:hover w-full block text-ceenter mt-4">Observar Curso</a>
