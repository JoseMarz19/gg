...
<head>
  <meta charset="utf-8">
  <title>Aprobacion de formato</title>
  <style>
...
@endphp
    <h1>📨 APROBACION DEL DOCUMENTO 🎉</h1>
    ...
    <p>¡Ha sido <span style="color: green;">APROBADO</span>! 🚀🎉</p>
    <p>Sin más por el momento, le deseo lo mejor. ¡Siga realizando sus documentos de la misma manera, increíble! 👏</p>
    <p>Atentamente,</p>
    <p>{{$user->name}} 👤</p>
