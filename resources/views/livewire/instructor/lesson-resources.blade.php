<div class="card" x-data="{ open: false }">
    <div class="card-body bg-gray-100">
        <header>
            <h1 x-on:click="open = !open" class="cursor-pointer"><i class="fa fa-folder text-yellow-500 mr-2"></i>Recursos de la lección</h1>
        </header>
            ...
            @if ($lesson->resource)
                <div class="flex justify-between items-center">
                    <p><i wire:click="download"
                            class="fas fa-download text-blue-500 mr-2 cursor-pointer"></i>{{ $lesson->resource->url }}
                    </p>
            ...
            @else
                <form wire:submit.prevent="save">
                    <div class="flex items-center">
                        ...
                        <button class="btn btn-primary_azul text-sm ml-2">Guardar</button>
                    </div>
