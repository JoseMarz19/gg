@php
 ...
 $nav_links = [
    ...
    [
            'name' => 'Carrito',
            'route' => route('courses.carrito'),
            'active' => request()->routeIs('courses.carrito'),
                ...
                <div class="ml-3 relative">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('courses.miscursos') }}" :active="request()->routeIs('course.miscursos')">
                                Mis cursos
                            </x-dropdown-link>
                            ...
                            @can('Leer cursos')
                            <x-dropdown-link href="{{ route('instructor.courses.index') }}" :active="request()->routeIs('instructor.courses.index')">
                                Instructor
                            </x-dropdown-link>
                            @endcan
                            ...
                            @can('Ver dashboard')
                            <x-dropdown-link href="{{ route('admin.home') }}" :active="request()->routeIs('instructor.courses.index')">
                                Administrador
                            </x-dropdown-link>
                            @endcan
